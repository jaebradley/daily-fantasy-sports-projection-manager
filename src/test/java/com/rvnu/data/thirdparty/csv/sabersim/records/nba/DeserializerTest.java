                                ...
                                try {
                                    assertEquals(
                                            new FanDuelPlayerProjection(
                                                    new com.rvnu.models.thirdparty.fanduel.nba.PlayerId(20840977),
                                                    new NonEmptyString("LeBron James"),
                                                    NonEmptyLinkedHashSet.from(Stream.of(com.rvnu.models.thirdparty.fanduel.nba.Position.SMALL_FORWARD, com.rvnu.models.thirdparty.fanduel.nba.Position.POWER_FORWARD).collect(Collectors.toCollection(LinkedHashSet::new))),
                                                    Team.LOS_ANGELES_LAKERS,
                                                    Team.MINNESOTA_TIMBERWOLVES,
                                                    new NonNegativeDollars(new NonNegativeDecimal(new BigDecimal("11400"))),
                                                    new BigDecimal("51.23"),
                                                    new NonNegativeDecimal(new BigDecimal("17.3"))
                                            ),
                                            playerProjection
                                    );
                                } catch (NonEmptyString.ValueMustNotBeEmpty | NonNegativeDecimal.ValueCannotBeNegative | NaturalNumber.ValueMustNotBeNegative | PositiveInteger.ValueMustBePositive | NonEmptyLinkedHashSet.CollectionCannotBeEmpty e) {
