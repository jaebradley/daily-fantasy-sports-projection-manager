...
public class Deserializer extends AbstractDeserializer<ContestPlayer, com.rvnu.data.thirdparty.csv.fanduel.record.nba.Deserializer.Column, com.rvnu.data.thirdparty.csv.fanduel.record.nba.Deserializer.Error> {
    ...
    private Deserializer(
            ...
            @NotNull final com.rvnu.data.firstparty.csv.record.deserialization.interfaces.Deserializer<ContestPlayer, com.rvnu.data.thirdparty.csv.fanduel.record.nba.Deserializer.Column, com.rvnu.data.thirdparty.csv.fanduel.record.nba.Deserializer.Error> resultDeserializer
    ) {
